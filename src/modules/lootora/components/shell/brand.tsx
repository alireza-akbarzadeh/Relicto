...
/** Lootora wordmarks as drawn in each header family. All link home to the marketplace. */
...
export function StudioBrand() {
  return (
    <Link href="/marketplace" className="flex items-center gap-space-sm">
      ...
      <div className="flex flex-col">
        <div className="flex items-center gap-space-xs">
          <span className="font-headline-sm text-headline-sm tracking-wider text-text-primary uppercase">Lootora</span>
