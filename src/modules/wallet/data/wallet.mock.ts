...
export const wallet: WalletData = {
  ...
  transactions: [
    ...
    { id: "tx-9840884", icon: "arrow_forward", title: "P2P Skin Sale Credit", hash: "#TX-9840884", asset: "★ Butterfly Knife | Doppler (Phase 4)", detail: "Buyer: @Kuro_Vault (Verified)", node: "Steam Escrow Bot #14", amount: "+$3,150.00", amountTone: "amber", status: "SETTLED", statusTone: "live", action: "Receipt", actionIcon: "receipt_long" },
