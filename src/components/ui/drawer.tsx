...
function DrawerSwipeHandle({
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className={cn(
        "relative z-10 flex shrink-0 cursor-grab py-2.5 transition-opacity duration-200 group-data-[swipe-axis=y]/drawer-popup:w-full group-data-[swipe-axis=y]/drawer-popup:justify-center after:block after:h-1.5 after:w-12 after:shrink-0 after:rounded-full after:bg-white/20 hover:after:bg-white/40 active:cursor-grabbing",
        className
      )}
      {...props}
    />
