...
/** Egress panel: the maximum is the live spendable balance; submitting files a real cashout request. */
export function WalletCashout({ rails, maxUsd }: { rails: WalletRailType[]; maxUsd: number }) {
