    ...
    <div className="flex flex-col gap-2">
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-3.5">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-black/60 shadow-inner backdrop-blur-md transition-colors group-hover:border-cyan-400/50">
            <SteamLogo className="size-7 fill-white drop-shadow-sm" />
          </div>
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <span className="font-display text-base font-bold tracking-tight text-white transition-colors group-hover:text-cyan-200">
                Sign In via Steam
              </span>
            ...
            <span className="mt-0.5 text-xs font-normal text-slate-300">OpenID 2.0 Auth • Instant Vault Sync • Zero Credential Leak</span>
          </div>
        </div>
